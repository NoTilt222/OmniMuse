...
class CustomTextInput extends StatelessWidget {
  ...
  final bool password;
  const CustomTextInput({Key? key, required this.label, required this.placeholder, required this.icon, required this.textEditingController, this.password = false}) : super(key: key);
          ...
          Padding(padding: const EdgeInsets.only(left: 20, bottom: 8),
            child: Text(
              ...
              style: TextStyle( color: Pallete.mainFontColor,
                fontFamily: 'Cera Pro',fontSize: 16, fontWeight: FontWeight.bold),
            ),
          ),
          SizedBox(
            height: 56,
